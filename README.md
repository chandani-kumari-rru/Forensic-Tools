...
| [Encase](https://www.opentext.com/products/forensic) | Paid | `Tool`: Imaging, Carvin; `Uses`: gathering & analysing digital evidence across computers, mobile devices & networs |
